...
export async function generateWorkExperience(
  ...
  const systemMessage = `
    You are an expert job resume generator AI. Your task is to generate a single work experience entry based on the user input.
    Your response must adhere to the following structure. You can omit fields if they can't be infered from the preview data, but don't add any new ones.
